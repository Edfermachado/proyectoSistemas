          ...
          <div className="hidden md:flex md:w-1/2 relative overflow-hidden">
            <div className="absolute inset-0 bg-university-blue/80 z-10 flex flex-col justify-center px-12 text-surface-white">
              ...
              <h1 className="font-headline-lg text-4xl mb-4 font-bold leading-tight">
                Únete hoy a tu comunidad
              </h1>
              <p className="font-body-lg text-base text-surface-variant opacity-90 max-w-sm leading-relaxed">
                Regístrate para descubrir y asistir a los mejores eventos académicos, deportivos y culturales de tu campus.
              </p>
            </div>
            {/* Thematic Image */}
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-surface-white">
            ...
            <form action={formAction} className="space-y-5">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-bold text-on-surface-variant" htmlFor="confirmPassword">
              ...
              <button
                disabled={pending}
                className="w-full bg-university-blue text-on-primary font-bold py-3.5 rounded-xl shadow-lg hover:shadow-xl hover:bg-primary-container transition-all active:scale-98 transform duration-150 cursor-pointer disabled:opacity-80 disabled:cursor-not-allowed mt-6"
                type="submit"
              >
                {pending ? (
              ...
              <p className="text-center text-sm text-slate-500 pt-2 font-medium">
                ...
                <Link href="/login" className="text-academic-gold font-bold hover:underline">
                  Inicia Sesión
                </Link>
              </p>
            </form>
